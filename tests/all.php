...
{
    define('PHPUnit_MAIN_METHOD', 'org_maemo_userdata_tests_all::main');
}
 ...
 * @package org_maemo_userdata
 */
class org_maemo_userdata_tests_all
{
...
if (PHPUnit_MAIN_METHOD == 'org_maemo_userdata_tests_all::main')
{
    org_maemo_userdata_tests_all::main();
}
?>